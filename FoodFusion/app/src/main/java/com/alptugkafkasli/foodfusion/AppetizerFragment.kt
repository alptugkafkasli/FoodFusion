...
import com.alptugkafkasli.foodfusion.databinding.FragmentAppetizerBinding
...
class AppetizerFragment : Fragment() {
    private var _binding: FragmentAppetizerBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAppetizerBinding.inflate(inflater, container, false)
        getData()
        return binding.root
    }
    ...
    private fun getData(){
        db.collection("Appetizer").get()
            .addOnSuccessListener { documents ->
                ...
                binding.nameAppetizer.text=name.toString()
                binding.descriptionAppetizer.text=description.toString()
                ...
                if (recipes != null && recipes.isNotEmpty()) {
                    ...
                    binding.recipesAppetizer.text = tariflerMetin.toString()
                } else {
                ...
                if (ingredients != null && ingredients.isNotEmpty()) {
                    ...
                    binding.ingredientsAppetizer.text = tariflerMetin.toString()
                } else {
                    println("Tarif bulunamadı veya boş.")
                }
