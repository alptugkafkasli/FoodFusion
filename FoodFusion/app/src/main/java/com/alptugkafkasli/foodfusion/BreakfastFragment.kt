    ...
    private fun getData(){
        db.collection("Breakfast").get()
            .addOnSuccessListener { documents ->
                ...
                binding.nameBreakfast.text=name.toString()
                binding.descriptionBreakfast.text=description.toString()
                ...
                if (recipes != null && recipes.isNotEmpty()) {
                    ...
                    binding.recipesBreakfast.text = tariflerMetin.toString()
                } else {
                ...
                if (ingredients != null && ingredients.isNotEmpty()) {
                    ...
                    binding.ingredientsBreakfast.text = tariflerMetin.toString()
                } else {
                    println("Tarif bulunamadı veya boş.")
                }
