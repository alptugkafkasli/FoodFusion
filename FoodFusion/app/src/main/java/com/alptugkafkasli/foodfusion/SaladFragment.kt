...
import com.alptugkafkasli.foodfusion.databinding.FragmentSaladBinding
    ...
    private fun getData(){
        db.collection("Salad").get()
            .addOnSuccessListener { documents ->
                ...
                binding.nameSalad.text=name.toString()
                binding.descriptionSalad.text=description.toString()
                ...
                if (recipes != null && recipes.isNotEmpty()) {
                    ...
                    binding.recipesSalad.text = tariflerMetin.toString()
                } else {
                ...
                if (ingredients != null && ingredients.isNotEmpty()) {
                    ...
                    binding.ingredientsSalad.text = tariflerMetin.toString()
                } else {
                    println("Tarif bulunamadı veya boş.")
                }
