...
import com.alptugkafkasli.foodfusion.databinding.FragmentMezzeBinding
...
class MezzeFragment : Fragment() {
    private var _binding: FragmentMezzeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMezzeBinding.inflate(inflater, container, false)
        getData()
        return binding.root
    }
    ...
    private fun setOnClickListeners(){
        binding.mezzeButton.setOnClickListener {
            getData()
        }
    ...
    private fun getData(){
        db.collection("Mezze").get()
            .addOnSuccessListener { documents ->
                ...
                binding.nameMezze.text=name.toString()
                binding.descriptionMezze.text=description.toString()
                ...
                if (recipes != null && recipes.isNotEmpty()) {
                    ...
                    binding.recipesMezze.text = tariflerMetin.toString()
                } else {
                ...
                if (ingredients != null && ingredients.isNotEmpty()) {
                    ...
                    binding.ingredientsMezze.text = tariflerMetin.toString()
                } else {
                    println("Tarif bulunamadı veya boş.")
                }
